...
curl -i -d 'identifier=clarence&rootUrl=http://clarence.ninja'  http://localhost:9393/sources
...
curl -i -d 'payload={"url":"http://clarence.ninja/ballin","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":123,"referredBy":"http://clarence.ninja","requestType":"POST","parameters":["slow"],"eventName": "beginRegistration","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/clarence/data

curl -i -d 'payload={"url":"http://clarence.ninja/about","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":13,"referredBy":"http://clarence.ninja","requestType":"POST","parameters":["slow"],"eventName": "beginRegistration","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/clarence/data

curl -i -d 'payload={"url":"http://clarence.ninja/news","requestedAt":"2013-01-14 21:38:28 -0700","respondedIn":12,"referredBy":"http://clarence.ninja","requestType":"POST","parameters":["slow"],"eventName": "beginRegistration","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/clarence/data

curl -i -d 'payload={"url":"http://clarence.ninja/ballin","requestedAt":"2013-01-14 21:48:28 -0700","respondedIn":23,"referredBy":"http://clarence.ninja","requestType":"POST","parameters":["slow"],"eventName": "beginRegistration","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/clarence/data

curl -i -d 'payload={"url":"http://clarence.ninja/ballin","requestedAt":"2013-01-14 21:52:01 -0700","respondedIn":23,"referredBy":"http://clarence.ninja","requestType":"POST","parameters":["slow"],"eventName": "beginRegistration","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/clarence/data

curl -i -d 'payload={"url":"http://clarence.ninja/about","requestedAt":"2013-01-14 22:18:28 -0700","respondedIn":42,"referredBy":"http://clarence.ninja","requestType":"POST","parameters":["slow"],"eventName": "beginRegistration","userAgent":"Mozilla/3.0 (Macintosh%3B Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1309.0 Safari/537.17","resolutionWidth":"800","resolutionHeight":"600","ip":"63.29.38.214"}' http://localhost:9393/sources/clarence/data
